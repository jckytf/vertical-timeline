(function() {
  ...
  document.getElementById("reverseOrderToggle").onclick = function() {
    var container = document.getElementsByClassName("cd-timeline__container")[0];
    var toggleClass = "timeline-reverse-order";
    if (
		container.className.includes(toggleClass)
    ) {
